...
const Sidebar = ({ groups, currentGroup, onGroupChange, onCreateGroup }) => {
  const menuItems = [
      ...
      <div className="p-6 pb-5 border-b border-white border-opacity-10">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <p className="font-bold text-base">Davi de Souza</p>
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs bg-white bg-opacity-20 px-2 py-0.5 rounded-full font-medium">Level 5</span>
            </div>
          </div>
        </div>
      </div>
